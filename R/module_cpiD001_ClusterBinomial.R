...
module_cpiD001_s02B_varselection_ui <- function(id){
...
module_cpiD001_s01_varselection_ui <- function(id){
...
module_cpiD001_s01_varselection_server <- function(id, input_general){
  moduleServer(
    id,
...
module_cpiD001_s02_rscience_ui <- function(id){
...
module_cpiD001_s02_rscience_server <- function(id, input_general, input_01_anova){
  moduleServer(
    id,
    function(input, output, session) {
      ...
      control_user_01 <- reactive({
        ...
        check_previous <- fn_cpiD001_control_previous(database = input_general()$database,
      ...
      RR_general <- reactive({
        ...
        the_output <- fn_cpiD001_results(database = input_general()$database,
                                                          selected_var_name = input_01_anova()$selected_var_name,
