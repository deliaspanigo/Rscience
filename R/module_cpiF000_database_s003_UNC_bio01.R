...
module_cpiF000_database_s03_UNC_bio01_ui <- function(id){
  ns <- shiny::NS(id)

  vector_opt <- c("Select one..." = "",
                  "01 - Base anova2ways -aleatorized" = "Rscience_bio02_anova2way_aleatorized",
                  "02 - Base anova2ways - mixed" = "Rscience_bio02_anova2way_mixed",
                  ...
                  "06 - Base06_pinzones" = "Rscience_bio01_base06_pinzones",
                  "07 - Base07_espermograma" = "Rscience_bio01_base07_espermograma")
...
module_cpiF000_database_s03_UNC_bio01_ui2 <- function(id){
  ns <- shiny::NS(id)
...
module_cpiF000_database_s03_UNC_bio01_server <- function(id, input_file_source){
  moduleServer(
    id,
