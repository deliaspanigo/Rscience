...
cpiA001_anova1way_code_sectionALL <- function(intro_source_database, vr_var_name, factor_var_name, alpha_value){
  ...
  vector_code[5] <- cpiA001_anova1way_code_sectionXX_g01_Plots()
  vector_code[6] <- cpiA001_anova1way_code_sectionXX_g02_Plots()
...
# # # Plots FACTOR
cpiA001_anova1way_factor_plot001 <- function(minibase_mod, df_factor_info){
...
cpiA001_anova1way_factor_plot002 <- function(df_table_factor_plot002){
  ...
  plot002_factor <-   add_trace(p = plot002_factor,
                               ...
                               marker = list(symbol = "line-ew-open",
                                             ...
                                             opacity = 1,
                                             line = list(width = 5)),
                               error_y = list(value = df_table_factor_plot002$model_error_sd)
  )
...
cpiA001_anova1way_factor_plot003 <- function(df_table_factor_plot003){
  ...
  plot003_factor <-   plotly::add_trace(p = plot003_factor,
                                       ...
                                       marker = list(symbol = "line-ew-open",
                                                     ...
                                                     opacity = 1,
                                                     line = list(width = 5)),
                                       error_y = list(value = df_table_factor_plot003$model_error_se)
  )
...
cpiA001_anova1way_factor_plot004 <- function(df_table_factor_plot004){
...
cpiA001_anova1way_factor_plot005 <- function(minibase_mod, df_table_factor_plot005){
...
cpiA001_anova1way_factor_plot006 <- function(minibase_mod, df_table_factor_plot006){
...
cpiA001_anova1way_factor_plot007 <- function(df_table_factor_plot007){
  ...
  plot007_factor <-   plotly::add_trace(p = plot007_factor,
                                        ...
                                        marker = list(symbol = "line-ew-open",
                                                      ...
                                                      opacity = 1,
                                                      line = list(width = 5)),
                                        error_y = list(value = df_table_factor_plot007$model_error_se)
  )
...
cpiA001_anova1way_recruit_g01_FactorPlots <- function(list_results_from_cpiA001_anova1way){
   ...
   all_plots <-  with(list_results_from_cpiA001_anova1way, {

      list_plots <- list()

      list_plots[[1]] <- cpiA001_anova1way_factor_plot001(minibase_mod, df_factor_info)
      list_plots[[2]] <- cpiA001_anova1way_factor_plot002(df_table_factor_plot002)
      list_plots[[3]] <- cpiA001_anova1way_factor_plot003(df_table_factor_plot003)
      list_plots[[4]] <- cpiA001_anova1way_factor_plot004(df_table_factor_plot004)
      list_plots[[5]] <- cpiA001_anova1way_factor_plot005(minibase_mod, df_table_factor_plot005)
      list_plots[[6]] <- cpiA001_anova1way_factor_plot006(minibase_mod, df_table_factor_plot006)
      list_plots[[7]] <- cpiA001_anova1way_factor_plot007(df_table_factor_plot007)
...
cpiA001_anova1way_residuals_plot001 <- function(minibase_mod, df_factor_info){
...
cpiA001_anova1way_residuals_plot002 <- function(minibase_mod, df_table_residuals_plot002){
...
cpiA001_anova1way_residuals_plot003 <- function(minibase_mod, df_table_residuals_plot003){
...
cpiA001_anova1way_residuals_plot004 <- function(minibase_mod){
...
cpiA001_anova1way_residuals_plot005 <- function(minibase_mod, model_error_sd){
  ...
  plot005_residuals <- add_trace(p = plot005_residuals,
                                 ...
                                 type = 'scatter',
                                 mode = 'lines',
                                 name = 'Distribucion Normal NO Estandard')
...
#  x <- x*model_error_sd
  ...
  plot005_residuals <- add_trace(p = plot005_residuals,
                                 ...
                                 type = 'scatter',
                                 mode = 'lines',
                                 name = 'Distribucion Normal Standard')
...
cpiA001_anova1way_recruit_g02_ResidualsPlots <- function(list_results_from_cpiA001_anova1way){
  ...
  all_plots <-  with(list_results_from_cpiA001_anova1way, {
    ...
    list_plots[[1]]  <- cpiA001_anova1way_residuals_plot001(minibase_mod, df_factor_info)
