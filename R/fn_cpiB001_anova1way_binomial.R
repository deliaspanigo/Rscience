...
cpiB001_anova1way_binomial_TakeCode <- function(selected_fn){
...
cpiB001_anova1way_binomial_ObjNamesInOrder <- function(selected_fn){
...
# # # # Control funcitons
# Control previous
cpiB001_anova1way_binomial_control_previous <- function(database, vr_var_name, factor_var_name, alpha_value){
...
# Control post
cpiB001_anova1way_binomial_control_post <- function(list_results_from_cpiB001_anova1way_binomial){

  # if(is.null(list_results_from_cpiB001_anova1way_binomial)){
  #   text_output <- "Control post test 001: Object 'list_results_from_cpiB001_anova1way_binomial' can not be NULL."
  #   check_ok <- FALSE
  ...
  #
  #
  # if(!(obj_name01 %in% names(list_results_from_cpiB001_anova1way_binomial))){
  #   text_output <- "Control post test 002: Object 'df_table_anova' doesn't exist in 'list_results_from_cpiB001_anova1way_binomial'."
  #   check_ok <- FALSE
  #   return(Hmisc::llist(check_ok, text_output))
  # }
  #
  #
  # # # # 1) About the table
  # if(is.null(list_results_from_cpiB001_anova1way_binomial[obj_name01])){
  ...
  #
  #
  # selected_obj01 <- list_results_from_cpiB001_anova1way_binomial[[obj_name01]]
  #
  #
...
cpiB001_anova1way_binomial_results <- function(database, vr_var_name, factor_var_name, alpha_value){
  ...
  # # # Anova test
  model_glm <- glm(VR~ FACTOR, family=binomial(link= "logit"), data = minibase)   # Linear model
  list_full_anova <- anova(model_glm, test = "Chisq")                                 # R results for anova
  summary_glm <- summary(model_glm)
  df_table_anova <- as.data.frame(list_full_anova)

  em <- emmeans(object = model_glm, specs = "FACTOR")
  list_contrast <- contrast(object = em, method = "pairwise", adjust = "Tukey")
  ...
  minibase_mod$"linear.predictor" <- model_glm$linear.predictor
  minibase_mod$"fitted.values" <- model_glm$fitted.values
  minibase_mod$"residuals" <- model_glm$residuals
  minibase_mod$"id_database" <- c(1:nrow(database))[dt_rows_database_ok]
  minibase_mod$"id_minibase" <- 1:nrow(minibase)

  # list_contrast <- contrast(object = em, method = "pairwise", adjust = "Tukey", type = "response")
  # confint(set_info, adjust = "Tukey", level = confidence_value, type = "response")
  # list_tukeymultiple_comparation <- contrast(multiple_comparation, "pairwise", adjust = "Tukey")



  vector_EE_PredLin <- summary_glm$coefficients[,2]
  vector_media_PredLin <- tapply(minibase_mod$linear.predictor, minibase_mod$FACTOR, mean)

  vector_maximo_PredLin <- vector_media_PredLin + vector_EE_PredLin
  vector_minimo_PredLin <- vector_media_PredLin - vector_EE_PredLin

  vector_error_upper_PredLin <- vector_maximo_PredLin - vector_media_PredLin
  vector_error_lower_PredLin <- vector_minimo_PredLin - vector_media_PredLin



  vector_media_VR <- exp(vector_media_PredLin)/(1+exp(vector_media_PredLin))

  vector_maximo_VR <- exp(vector_maximo_PredLin)/(1+exp(vector_maximo_PredLin))
  vector_minimo_VR <- exp(vector_minimo_PredLin)/(1+exp(vector_minimo_PredLin))

  vector_error_upper_VR <- vector_maximo_VR - vector_media_VR
  vector_error_lower_VR <- vector_minimo_VR - vector_media_VR

  df_resumen01 <- data.frame(
    "orden" = 1:length(vector_media_VR),
    "lvl" = names(vector_media_VR),
    "RV_mean" = vector_media_VR,
    "PredLin_mean" = vector_media_PredLin
  )


  df_resumen02 <- data.frame(
    "orden" = 1:length(vector_media_PredLin),
    "level" = names(vector_media_PredLin),
    "PredLin_mean" = vector_media_PredLin,
    "PredLin_min" = vector_minimo_PredLin,
    "PredLin_max" = vector_maximo_PredLin,
    "PredLin_lower_error" = vector_error_lower_PredLin,
    "PredLin_upper_error" = vector_error_upper_PredLin,
    "color" = df_factor_info$color
  )


  df_resumen03 <- data.frame(
    "orden" = 1:length(vector_media_VR),
    "level" = names(vector_media_VR),
    "VR_mean" = vector_media_VR,
    "VR_min" = vector_minimo_VR,
    "VR_max" = vector_maximo_VR,
    "VR_lower_error" = vector_error_lower_VR,
    "VR_upper_error" = vector_error_upper_VR,
    "color" = df_factor_info$color
  )
  ...
  hide_correct_order <- cpiB001_anova1way_binomial_ObjNamesInOrder(selected_fn = cpiB001_anova1way_binomial_results)
...
cpiB001_anova1way_binomial_code_section01_Libreries <- function(){
...
cpiB001_anova1way_binomial_code_section02_FileSource <- function(intro_source_database){
...
cpiB001_anova1way_binomial_code_section03_VarSelection <- function(vr_var_name, factor_var_name, alpha_value){
...
cpiB001_anova1way_binomial_code_section04_UntilTheEnd <- function(){


  the_code <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_results)

  return(the_code)
}


cpiB001_anova1way_binomial_code_sectionXX_g01_Plots <- function(){



  list_code <- list()

  list_code[[1]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot001)
  list_code[[2]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot002)
  list_code[[3]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot003)
  list_code[[4]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot004)
  list_code[[5]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot005)
  list_code[[6]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot006)
  list_code[[7]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_factor_plot007)
...
cpiB001_anova1way_binomial_code_sectionXX_g02_Plots <- function(){


  list_code <- list()

  list_code[[1]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot001)
  list_code[[2]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot002)
  list_code[[3]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot003)
  list_code[[4]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot004)
  list_code[[5]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot005)
  list_code[[6]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot006)
  list_code[[7]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot007)
  list_code[[8]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot008)
  list_code[[9]]  <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot009)
  list_code[[10]] <- cpiB001_anova1way_binomial_TakeCode(selected_fn = cpiB001_anova1way_binomial_residuals_plot010)
  ...
  # objetos <- ls("package:Rscience", pattern = "^cpiB001_anova1way_binomial_residuals_plot+[0-9]+")
  #
  #
  #
  # # Filtrar solo las funciones que coinciden con el patrón
  # #list_plot <- objetos[grep("^cpiB001_anova1way_binomial_plot[0-9]+", objetos)]
  # list_plot <- objetos
  ...
  #
  #
  #   selected_code <- paste0("cpiB001_anova1way_binomial_TakeCode(", x, ")")
...
cpiB001_anova1way_binomial_code_sectionALL <- function(intro_source_database, vr_var_name, factor_var_name, alpha_value){

  # objetos <- ls()
  #
  # # Filtrar solo las funciones que coinciden con el patrón
  # selected_fun <- objetos[grep("^cpiB001_anova1way_binomial_code_section[0-9]+_[a-zA-Z]", objetos)]
  # selected_fun <- sort(selected_fun)

  vector_code <- list()

  vector_code[1] <- cpiB001_anova1way_binomial_code_section01_Libreries()
  vector_code[2] <- cpiB001_anova1way_binomial_code_section02_FileSource(intro_source_database)
  vector_code[3] <- cpiB001_anova1way_binomial_code_section03_VarSelection(vr_var_name, factor_var_name, alpha_value)
  vector_code[4] <- cpiB001_anova1way_binomial_code_section04_UntilTheEnd()
  vector_code[5] <- cpiB001_anova1way_binomial_code_sectionXX_g01_Plots()
  vector_code[6] <- cpiB001_anova1way_binomial_code_sectionXX_g02_Plots()
...
cpiB001_anova1way_binomial_recruit_g01_Tables <- function(list_results_from_cpiB001_anova1way_binomial){


  all_tables <- with(list_results_from_cpiB001_anova1way_binomial, {
...
cpiB001_anova1way_binomial_recruit_g02_Tables <- function(list_results_from_cpiB001_anova1way_binomial){
...
# # # Plots FACTOR
cpiB001_anova1way_binomial_factor_plot001 <- function(minibase_mod, df_factor_info){
...
cpiB001_anova1way_binomial_factor_plot002 <- function(df_table_factor_plot002){
...
cpiB001_anova1way_binomial_factor_plot003 <- function(df_table_factor_plot003){
...
cpiB001_anova1way_binomial_factor_plot004 <- function(df_table_factor_plot004){
...
cpiB001_anova1way_binomial_factor_plot005 <- function(minibase_mod, df_table_factor_plot005){
...
cpiB001_anova1way_binomial_factor_plot006 <- function(minibase_mod, df_table_factor_plot006){
...
cpiB001_anova1way_binomial_factor_plot007 <- function(df_table_factor_plot007){
...
cpiB001_anova1way_binomial_recruit_g01_FactorPlots <- function(list_results_from_cpiB001_anova1way_binomial){



  all_plots <-  with(list_results_from_cpiB001_anova1way_binomial, {

    list_plots <- list()

    list_plots[[1]] <- cpiB001_anova1way_binomial_factor_plot001(minibase_mod, df_factor_info)
    list_plots[[2]] <- cpiB001_anova1way_binomial_factor_plot002(df_table_factor_plot002)
    list_plots[[3]] <- cpiB001_anova1way_binomial_factor_plot003(df_table_factor_plot003)
    list_plots[[4]] <- cpiB001_anova1way_binomial_factor_plot004(df_table_factor_plot004)
    list_plots[[5]] <- cpiB001_anova1way_binomial_factor_plot005(minibase_mod, df_table_factor_plot005)
    list_plots[[6]] <- cpiB001_anova1way_binomial_factor_plot006(minibase_mod, df_table_factor_plot006)
    list_plots[[7]] <- cpiB001_anova1way_binomial_factor_plot007(df_table_factor_plot007)
...
cpiB001_anova1way_binomial_residuals_plot001 <- function(minibase_mod, df_factor_info){
...
cpiB001_anova1way_binomial_residuals_plot002 <- function(minibase_mod, df_table_residuals_plot002){
...
cpiB001_anova1way_binomial_residuals_plot003 <- function(minibase_mod, df_table_residuals_plot003){
...
cpiB001_anova1way_binomial_residuals_plot004 <- function(minibase_mod){
...
cpiB001_anova1way_binomial_residuals_plot005 <- function(minibase_mod){
...
cpiB001_anova1way_binomial_residuals_plot006 <- function(minibase_mod, df_factor_info){
...
cpiB001_anova1way_binomial_residuals_plot007 <- function(minibase_mod, df_factor_info){
...
cpiB001_anova1way_binomial_residuals_plot008 <- function(minibase_mod){
...
cpiB001_anova1way_binomial_residuals_plot009 <- function(minibase_mod){
...
cpiB001_anova1way_binomial_residuals_plot010 <- function(minibase_mod){
...
cpiB001_anova1way_binomial_recruit_g02_ResidualsPlots <- function(list_results_from_cpiB001_anova1way_binomial){
  ...
  all_plots <-  with(list_results_from_cpiB001_anova1way_binomial, {
    ...
    list_plots[[1]]  <- cpiB001_anova1way_binomial_residuals_plot001(minibase_mod, df_factor_info)
    list_plots[[2]]  <- cpiB001_anova1way_binomial_residuals_plot002(minibase_mod, df_table_residuals_plot002)
    list_plots[[3]]  <- cpiB001_anova1way_binomial_residuals_plot003(minibase_mod, df_table_residuals_plot003)
    list_plots[[4]]  <- cpiB001_anova1way_binomial_residuals_plot004(minibase_mod)
    list_plots[[5]]  <- cpiB001_anova1way_binomial_residuals_plot005(minibase_mod)
    list_plots[[6]]  <- cpiB001_anova1way_binomial_residuals_plot006(minibase_mod, df_factor_info)
    list_plots[[7]]  <- cpiB001_anova1way_binomial_residuals_plot007(minibase_mod, df_factor_info)
    list_plots[[8]]  <- cpiB001_anova1way_binomial_residuals_plot008(minibase_mod)
    list_plots[[9]]  <- cpiB001_anova1way_binomial_residuals_plot009(minibase_mod)
    list_plots[[10]] <- cpiB001_anova1way_binomial_residuals_plot010(minibase_mod)
