...
module_cpiA011_s01_varselection_ui <- function(id){
...
module_cpiA011_s01_varselection_server <- function(id, input_general){
  moduleServer(
    id,
...
module_cpiA011_s02_rscience_ui <- function(id){
...
module_cpiA011_s02_rscience_server <- function(id, input_general, input_01_anova){
  moduleServer(
    id,
    function(input, output, session) {
      ...
      output$tab01_analysis_slop_01A <- renderPrint({
...
##################################################################################
      ...
      RR_general_Z <- reactive({
        ...
        the_output_Z <- fn_cpiA010_gen02(database = input_general()$database,
                                       vr_var_name = input_01_anova()$vr_var_name,
                                       factor_var_name = input_01_anova()$factor_var_name,
                                       cov_var_name = input_01_anova()$cov_var_name,
                                       alpha_value = input_01_anova()$alpha_value)
      ...
      output$tab01_analysis_slop_01C <- renderPrint({
        ...
        div(
          fluidRow(
            column(12,
                   ...
                   br(), br(), br(),
                   h2("3) Ancova without interaction"),
