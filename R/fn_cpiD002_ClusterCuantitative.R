...
# # # # Control funcitons
# Control previous
fn_cpiD002_control_previous <- function(database, selected_var_name, selected_var_labels, alpha_value){
...
fn_cpiD002_results <- function(database, selected_var_name, selected_var_labels, alpha_value){
