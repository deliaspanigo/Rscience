...
module_cpiB006_s01_varselection_ui <- function(id){
...
module_cpiB006_s01_varselection_server <- function(id, input_general){
  moduleServer(
    id,
    function(input, output, session) {
      ...
      output$vars_selection <- renderUI({
        ...
        div(shinyjs::useShinyjs(), id = ns("input-var-selection"),
            fluidRow(
              column(12, h1("Generalized Linear Modelo - Simple Linear Regresion - Poisson"))
            ),
            fluidRow(
              column(6,
...
module_cpiB006_s02_rscience_ui <- function(id){
...
module_cpiB006_s02_rscience_server <- function(id, input_general, input_01_anova){
  moduleServer(
    id,
    function(input, output, session) {
      ...
      control_user_01 <- reactive({
        ...
        # )
        #
        # check_previous <- cpiB006_slr_poisson_control_previous(database = input_general()$database,
      ...
      RR_general <- reactive({
        ...
        the_output <- cpiB006_slr_poisson_results(database = input_general()$database,
                                                   vr_var_name = input_01_anova()$vr_var_name,
                                                   x_var_name = input_01_anova()$x_var_name,
                                                   alpha_value = input_01_anova()$alpha_value)
      ...
      control_user_02 <- reactive({
        ...
        #
        #         # Control post
        # check_post <- cpiB006_slr_poisson_control_post(list_results_from_cpiA001_anova1way = RR_general())
        # #
        # validate(
      ...
      #
      #   req(control_user_02())
      #   all_tables_g01 <- cpiB006_slr_poisson_recruit_g01_Tables(list_results_from_cpiA001_anova1way = RR_general())
      #   all_tables_g01
      # })
      #
      #
      ...
      #
      #   req(control_user_02())
      #   all_plots_g01 <- cpiB006_slr_poisson_recruit_g01_FactorPlots(list_results_from_cpiA001_anova1way = RR_general())
      #   all_plots_g01
      # })
      #
      #
      ...
      #
      #   req(control_user_02())
      #   all_tables_g02 <- cpiB006_slr_poisson_recruit_g02_Tables(list_results_from_cpiA001_anova1way = RR_general())
      #   all_tables_g02
      # })
      ...
      #
      #   req(control_user_02())
      #   all_plots_g02 <- cpiB006_slr_poisson_recruit_g02_ResidualsPlots(list_results_from_cpiA001_anova1way = RR_general())
      #   all_plots_g02
      # })
      ...
      RR_code <- reactive({
        ...
        req(control_user_02())
        the_code <- cpiB006_slr_poisson_code_sectionALL(intro_source_database = input_01_anova()$intro_source_database,
                                                         vr_var_name = input_01_anova()$vr_var_name,
