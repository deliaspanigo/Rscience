...
module_cpiA010_s01_varselection_ui <- function(id){
...
module_cpiA010_s01_varselection_server <- function(id, input_general){
  moduleServer(
    id,
...
module_cpiA010_s02_rscience_ui <- function(id){
...
module_cpiA010_s02_rscience_server <- function(id, input_general, input_01_anova){
  moduleServer(
    id,
    function(input, output, session) {
      ...
      RR_general <- reactive({
        ...
        the_output <- fn_cpiA010_gen02(database = input_general()$database,
                                       vr_var_name = input_01_anova()$vr_var_name,
