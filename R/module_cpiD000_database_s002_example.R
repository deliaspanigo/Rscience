...
module_cpiD000_database_s02_example_ui <- function(id){
  ns <- shiny::NS(id)
...
# # # 01) UI - Selection for 'database'
module_cpiD000_database_s02_example_ui2 <- function(id){
  ns <- shiny::NS(id)
...
module_cpiD000_database_s02_example_server <- function(id, input_file_source){
  moduleServer(
    id,
