...
module_cpiE000_database_s03_UNC_bio01_ui <- function(id){
  ns <- shiny::NS(id)
...
module_cpiE000_database_s03_UNC_bio01_ui2 <- function(id){
  ns <- shiny::NS(id)
...
module_cpiE000_database_s03_UNC_bio01_server <- function(id, input_file_source){
  moduleServer(
    id,
