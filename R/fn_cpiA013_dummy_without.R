...
fn_cpiA013_TakeCode <- function(selected_fn){
...
fn_cpiA013_ObjNamesInOrder <- function(selected_fn){
...
# # # # Control funcitons
# Control previous
fn_cpiA013_control_previous <- function(database, vr_var_name, x01_var_name, x02_var_name,alpha_value){
...
fn_cpiA013_code_p01_test_without <- function(database, vr_var_name, factor_var_name, cov_var_name, alpha_value){
  ...
  # Analisis
  lm_dummy_without <- lm(VR ~ REG + FACTOR, data = minibase)
  summary_dummy_without <- summary(lm_dummy_without)
  df_coefficients <-  as.data.frame(summary_dummy_without$coefficients)
  # vector_coeff <- df_coefficients$Estimate

  # # # Standard error from model for each level
  model_error_var <- var(lm_dummy_without$residuals)
  ...
  minibase_mod$"fitted.values" <- lm_dummy_without$fitted.values
  minibase_mod$"residuals" <- lm_dummy_without$residuals
  ...
  vector_slope_levels <- rep(df_coefficients$"Estimate"[2], nlevels(minibase[,2]))
  ...
  hide_correct_order <- fn_cpiA013_ObjNamesInOrder(selected_fn = fn_cpiA013_code_p01_test_without)
...
fn_cpiA013_code_p02_plot001 <- function(results_p01_test){
...
fn_cpiA013_code_p02_plot002 <- function(results_p01_test){
...
fn_cpiA013_code_p02_plot003 <- function(results_p01_test){
...
fn_cpiA013_code_p02_plot004 <- function(results_p01_test){
...
# Control post
fn_cpiA013_control_p01_test <- function(all_results){
...
fn_cpiA013_control_p02_plots <- function(all_results){
...
fn_cpiA013_gen01 <- function(database,  vr_var_name, factor_var_name, cov_var_name,alpha_value){
  ...
  # Step 01 - R_code
  output_list$"R_code"$"p01_test"    <- fn_cpiA013_TakeCode(selected_fn = fn_cpiA013_code_p01_test_without)
  output_list$"R_code"$"p02_plots"$"plot001"   <- fn_cpiA013_TakeCode(selected_fn = fn_cpiA013_code_p02_plot001)
  output_list$"R_code"$"p02_plots"$"plot002"   <- fn_cpiA013_TakeCode(selected_fn = fn_cpiA013_code_p02_plot002)
  output_list$"R_code"$"p02_plots"$"plot003"   <- fn_cpiA013_TakeCode(selected_fn = fn_cpiA013_code_p02_plot003)
  output_list$"R_code"$"p02_plots"$"plot004"   <- fn_cpiA013_TakeCode(selected_fn = fn_cpiA013_code_p02_plot004)


  # Step 02 - Pre Control ------------------------------------------------------
  output_list$"check_control"$"previous" <- fn_cpiA013_control_previous(database, vr_var_name,
                                                                        factor_var_name,
                                                                        cov_var_name,
                                                                        alpha_value)
  ...
  # Step 03 - Results ----------------------------------------------------------
  output_list$"R_results"$"p01_test" <- fn_cpiA013_code_p01_test_without(database,  vr_var_name, factor_var_name, cov_var_name, alpha_value)


  output_list$"R_results"$"p02_plots"$"plot001" <- fn_cpiA013_code_p02_plot001(results_p01_test = output_list$"R_results"$"p01_test")
  output_list$"R_results"$"p02_plots"$"plot002" <- fn_cpiA013_code_p02_plot002(results_p01_test = output_list$"R_results"$"p01_test")
  output_list$"R_results"$"p02_plots"$"plot003" <- fn_cpiA013_code_p02_plot003(results_p01_test = output_list$"R_results"$"p01_test")
  output_list$"R_results"$"p02_plots"$"plot004" <- fn_cpiA013_code_p02_plot004(results_p01_test = output_list$"R_results"$"p01_test")
...
fn_cpiA013_gen02 <- function(database,  vr_var_name, factor_var_name, cov_var_name, alpha_value){


  all_results <- fn_cpiA013_gen01(database,  vr_var_name, factor_var_name, cov_var_name, alpha_value)
