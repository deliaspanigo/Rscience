...
module_cpiE003_s01_varselection_ui <- function(id){
...
module_cpiE003_s01_varselection_server <- function(id, input_general){
  moduleServer(
    id,
...
module_cpiE003_s02_rscience_ui <- function(id){
...
module_cpiE003_s02_rscience_server <- function(id, input_general, input_01_anova){
  moduleServer(
    id,
    function(input, output, session) {
